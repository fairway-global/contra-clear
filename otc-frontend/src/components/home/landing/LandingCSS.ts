...
.klp {
  --bg:#0a0a0a;--bg-card:rgba(255,255,255,0.03);--bg-card-hover:rgba(255,255,255,0.06);
  --white:#ffffff;--text:#ffffffcc;--text-muted:#ffffff66;--text-dim:#ffffff33;
  --accent:#00FFD1;--accent-dim:rgba(0,255,209,0.15);--accent-glow:rgba(0,255,209,0.4);
  --border:rgba(255,255,255,0.08);--border-light:rgba(255,255,255,0.12);
  --font-sans:'DM Sans','General Sans','Inter',-apple-system,sans-serif;
...
.klp .logo{display:flex;align-items:center;gap:10px;font-size:20px;color:var(--white);flex-shrink:0;cursor:pointer}
.klp .logo-img{height:36px;width:auto;object-fit:contain}
.klp .logo-img--small{height:28px}
.klp .logo-text{font-family:var(--font-mono);font-weight:700;letter-spacing:.16em;font-size:.9rem;color:var(--accent);text-transform:uppercase;white-space:nowrap}
.klp .logo--small .logo-text{font-size:.75rem}
...
.klp .powered-globe-logo{width:180px;height:180px;object-fit:contain;position:relative;z-index:2;filter:drop-shadow(0 0 40px rgba(0,255,209,.25))}
...
.klp .faq-lore{position:relative;margin:36px 0 0;padding:22px 22px 20px;max-width:440px;background:linear-gradient(165deg,rgba(124,58,237,.06) 0%,rgba(0,255,209,.025) 45%,rgba(0,0,0,0) 100%);border:1px solid rgba(255,255,255,.06);border-radius:2px;overflow:hidden;isolation:isolate}
.klp .faq-lore::before{content:'';position:absolute;inset:0;background:radial-gradient(120% 60% at 0% 0%,rgba(0,255,209,.08),transparent 60%);pointer-events:none;z-index:-1}
.klp .faq-lore-aurora{position:absolute;left:-20%;right:-20%;top:-1px;height:1px;background:linear-gradient(90deg,transparent 0%,rgba(124,58,237,.4) 25%,rgba(0,255,209,.85) 50%,rgba(6,182,212,.5) 70%,transparent 100%);filter:blur(.3px);box-shadow:0 0 12px rgba(0,255,209,.35);pointer-events:none}
...
.klp .faq-lore-rule{flex:1;height:1px;background:linear-gradient(90deg,rgba(0,255,209,.45),transparent);opacity:.8}
...
.klp .faq-lore-dot{display:inline-block;width:5px;height:5px;border-radius:50%;background:var(--accent);box-shadow:0 0 8px rgba(0,255,209,.7);animation:klp-lore-pulse 3.2s ease-in-out infinite}
